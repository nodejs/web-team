...
* Define how partners should be ranked [#8995](https://github.com/nodejs/nodejs.org/issues/8995)
  ...
  * Do the categories equate to weights? Can some alogrithm derive this?
  ...
  * Some partners (especially website), are missing... like Sentry, Orama, Crowdin, Chromatic, etc.
