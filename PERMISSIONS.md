...
| Repository                               | Everyone | @nodejs/web | @nodejs/nodejs-website | @nodejs/doc-kit | @nodejs/web-infra | @nodejs/web-admins | Notes                                                                                                       |
| ---------------------------------------- | -------- | ----------- | ---------------------- | --------------- | ----------------- | ------------------ | ----------------------------------------------------------------------------------------------------------- |
| **[nodejs/discord-status-worker][]**     | Read     | -           | -                      | -               | Maintain          | Admin              |                                                                                                             |
| **[nodejs/doc-kit][]**                   | Read     | -           | Write                  | Maintain        | Maintain          | Admin              | @nodejs/doc-kit holds no publishing access; releases and the Vercel project are owned by @nodejs/web-infra. |
...
| Service                      | Everyone                           | @nodejs/web | @nodejs/nodejs-website | @nodejs/doc-kit | @nodejs/web-infra | @nodejs/web-admins | Notes                                                                                                                                                                  |
| ---------------------------- | ---------------------------------- | ----------- | ---------------------- | --------------- | ----------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
